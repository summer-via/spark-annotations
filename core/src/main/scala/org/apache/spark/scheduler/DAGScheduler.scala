...
class DAGScheduler(
  ...
  def submitJob[T, U](
    ...
    // 向event loop发送任务， 真正执行时最在handlexxx
  ...
  def runJob[T, U](
    ...
    // safe to pass in null h
    // ere. For more detail, see SPARK-13747.
  ...
  private[scheduler] def handleJobSubmitted(jobId: Int,
    ...
    try {
      ...
      // **核心代码**，bfs划分stage，返回的ResultStage带有parentStages
